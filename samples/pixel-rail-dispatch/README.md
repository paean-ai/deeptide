...
A dependency-free pixel-art route trains, ship cargo, and prevent platform gridlock. sample with a complete loop: resources, facilities, upgrades, timed actions, events, save/load, and bilingual UI.
...
- Watch the goal meter. Reaching **On-Time 78** wins the run.
