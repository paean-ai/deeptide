...
A dependency-free pixel-art inspect rooms, combine clues, and unlock layered puzzles. sample with a complete loop: resources, facilities, upgrades, timed actions, events, save/load, and bilingual UI.
...
- Watch the goal meter. Reaching **Rooms 16** wins the run.
