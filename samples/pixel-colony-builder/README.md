# Pixel Colony Builder

A dependency-free pixel-art gather, shelter, research, and survive hostile seasons. sample with a complete loop: resources, facilities, upgrades, timed actions, events, save/load, and bilingual UI.
...
- Watch the goal meter. Reaching **Stability 90** wins the run.
