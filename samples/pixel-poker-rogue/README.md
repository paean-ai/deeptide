...
A dependency-free pixel-art build scoring engines from hands, charms, and risky blinds. sample with a complete loop: resources, facilities, upgrades, timed actions, events, save/load, and bilingual UI.
...
- Watch the goal meter. Reaching **Score 120** wins the run.
