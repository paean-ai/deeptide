...
A dependency-free pixel-art prep stations, serve combos, survive the dinner rush. sample with a complete loop: resources, facilities, upgrades, timed actions, events, save/load, and bilingual UI.
...
- Watch the goal meter. Reaching **Stars 80** wins the run.
