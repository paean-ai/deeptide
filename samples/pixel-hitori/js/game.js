// Pixel Hitori - tap-to-cycle play, win detection, save.
...
const SAVE_KEY = 'pixel-hitori-save';
...
function updateHud() {
  ...
  const shaded = Array.from(state.cells).filter(v => v === SHADED).length;
  document.getElementById('hud-shaded').textContent = '■ ' + shaded;
