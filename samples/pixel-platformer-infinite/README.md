...
Dependency-free HTML Canvas pixel platformer sample.
...
Then visit `http://127.0.0.1:4176/index.html`.

## Controls

- Desktop: `A/D` or arrow keys to move, `Space/J` jump, `K` attack, `L/Shift` dash.
- Mobile: left/right buttons on the left, dash/attack/jump buttons on the right.
