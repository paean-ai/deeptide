...
A dependency-free pixel-art scout, loot, rotate, and outplay the final circle. sample with a complete loop: resources, facilities, upgrades, timed actions, events, save/load, and bilingual UI.
...
- Watch the goal meter. Reaching **Standing 100** wins the run.
