...
- 6-sector campaign with rising asteroid counts and a few sectors that start
  with medium asteroids already in the mix.
...
- Every sector verified clearable by an automated aim-and-fire bot.
- English / 中文 toggle.
