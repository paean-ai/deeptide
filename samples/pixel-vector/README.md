...
- 11-sector campaign with rising asteroid counts and sectors that start
  with medium or pre-broken small asteroids already in the mix — the final
  sectors (Comet Trail, Debris Field, Cosmic Wrath) pile on big, medium and
  small rocks together for a frantic close.
...
- All 11 sectors build with sane rock counts and load cleanly (35
  verification checks).
- English / 中文 toggle.
